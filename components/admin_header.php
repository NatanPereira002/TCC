...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="../admin/dashboard.php" class="logo">Painel do <span>Administrador</span></a>

      <nav class="navbar">
         <a href="../admin/dashboard.php">Home</a>
         <a href="../admin/products.php">Produtos</a>
         <a href="../admin/placed_orders.php">Ordens</a>
      ...
      <div class="profile">
         ...
         <a href="../admin/update_profile.php" class="btn">Atualizar conta</a>
         <div class="flex-btn">
