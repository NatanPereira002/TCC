   ...
   <form action="" method="post" enctype="multipart/form-data">
      <div class="flex">
         <div class="inputBox">
            ...
            <input type="text" class="box" required maxlength="100" placeholder="Nome do produto" name="name">
         </div>
         <div class="inputBox">
            <span>Preço do produto</span>
            <input type="number" min="0" class="box" required max="9999999999" placeholder="Preço do produto" onkeypress="if(this.value.length == 10) return false;" name="price">
         </div>
        <div class="inputBox">
            <span>imagem 1</span>
        ...
        <div class="inputBox">
         ...
         <div class="inputBox">
            ...
            <textarea name="details" placeholder="Descrição do produto" class="box" required maxlength="500" cols="30" rows="10"></textarea>
         </div>
      </div>
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         ...
         <a href="products.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('delete this product?');">deletar</a>
      </div>
   </div>
   <?php
         }
