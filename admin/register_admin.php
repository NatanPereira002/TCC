...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>Registrar</h3>
      <input type="text" name="name" required placeholder="Digite seu nome" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
